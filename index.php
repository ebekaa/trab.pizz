<?php
  include_once("templates/header.php");   /*Cabeçalho incluido na página*/
...
?>
  ...
  <div id="main-container"> <!--Container principal!-->
    <div class="container">
      <div class="row">
        <div class="col-md-12"> <!--Ocupando a largura de toda tela disponível!-->
...
<?php
  include_once("templates/footer.php"); /*Rodapé incluido na página*/
?>